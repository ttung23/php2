    ...
    <table class="mx-auto">
        ...
        <tr>
            ...
            <?php if (isset($err['name_product'])) { ?>
                <td class="error text-red-500"><?= $err['name_product'] ?></td>
            <?php } ?>
        </tr>
        ...
        <tr>
            ...
            <?php if (isset($err['price_product'])) { ?>
                <td class="error text-red-500"><?= $err['price_product'] ?></td>
            <?php } ?>
        </tr>
        ...
        <tr>
            ...
            <?php if (isset($err['quantity_product'])) { ?>
                <td class="error text-red-500"><?= $err['quantity_product'] ?></td>
            <?php } ?>
        </tr>
        ...
        <tr>
            ...
            <?php if (isset($err['description'])) { ?>
                <td class="error text-red-500"><?= $err['description'] ?></td>
            <?php } ?>
        </tr>
